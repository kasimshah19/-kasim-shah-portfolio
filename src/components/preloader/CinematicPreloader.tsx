  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="absolute right-0 top-1/2 -translate-y-1/2 w-96 h-96 bg-[#D94E28]/10 rounded-full blur-3xl pointer-events-none" />
      </motion.div>
      ...
      >
        ...
        />
        {/* Ambient radial glow at center point */}
        <div className="absolute left-0 top-1/2 -translate-y-1/2 w-96 h-96 bg-[#D94E28]/10 rounded-full blur-3xl pointer-events-none" />
      </motion.div>
        ...
        {phase !== 'revealing' && (
          ...
          >
            {ambientTokens.map((token, idx) => (
              <motion.div
                key={idx}
                className="absolute font-mono text-[11px] text-[#7A756B]/20 tracking-wider select-none font-medium"
                style={{
                  top: token.top,
                  left: token.left,
                  right: token.right,
      ...
      <div className="absolute inset-0 z-40 flex flex-col items-center justify-center px-6 pointer-events-none">
        ...
        >
          ...
          >
            ...
            <div className="absolute -inset-4 bg-gradient-to-r from-[#D94E28]/15 via-[#FAF7F2]/5 to-[#D94E28]/15 rounded-3xl blur-xl opacity-60" />
            ...
            <div className="relative w-20 h-20 sm:w-24 sm:h-24 rounded-2xl bg-[#141413] border border-[#2B2925] shadow-2xl flex items-center justify-center">
              ...
              <div className="absolute top-1.5 left-1.5 w-2 h-2 border-t border-l border-[#D94E28]/50" />
              <div className="absolute bottom-1.5 right-1.5 w-2 h-2 border-b border-r border-[#D94E28]/50" />

              <span className="text-4xl sm:text-5xl font-extrabold tracking-tighter text-[#FAF7F2] font-display flex items-baseline">
                <span>KS</span>
                <span className="text-[#D94E28] ml-0.5 text-3xl sm:text-4xl leading-none">.</span>
              </span>
            </div>
          </motion.div>
          ...
          <div className="space-y-2">
            ...
            >
              <h1 className="text-2xl sm:text-3xl font-extrabold tracking-[0.25em] text-[#FAF7F2] font-display uppercase">
                Kasim Shah
              </h1>
            </motion.div>
            ...
            <motion.div
              ...
              className="space-y-1"
            >
              <div className="text-xs sm:text-sm font-mono tracking-[0.22em] text-[#D94E28] font-bold uppercase">
                MERN STACK DEVELOPER
              </div>
              <div className="text-[10px] sm:text-[11px] font-mono tracking-[0.16em] text-[#8C877D] uppercase font-medium">
          ...
          >
            ...
            <div className="relative w-full h-[3px] bg-[#22211F] rounded-full overflow-hidden">
              <motion.div
                className="absolute top-0 left-0 bottom-0 bg-gradient-to-r from-[#D94E28]/80 via-[#D94E28] to-[#FFA07A] rounded-full"
            ...
            <div className="flex items-center justify-between text-[10px] sm:text-[11px] font-mono tracking-wider">
              {/* Dynamic Status Text */}
              <div className="flex items-center gap-1.5 text-[#9C968B] truncate mr-2">
                <span
                  className={`w-1.5 h-1.5 rounded-full ${
                    phase === 'ready'
                      ? 'bg-[#10B981] animate-ping'
                      : 'bg-[#D94E28] animate-pulse'
                  }`}
                />
              ...
              <div className="text-[#FAF7F2] font-semibold tabular-nums shrink-0">
