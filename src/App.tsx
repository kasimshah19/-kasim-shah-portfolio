...
export default function App() {
  ...
  return (
    <div className="relative min-h-screen bg-[#F4F0E8] text-[#141413] flex flex-col font-sans overflow-x-hidden">
      ...
      <div className="lg:ml-64 flex-1 flex flex-col min-w-0">
        ...
        <HeaderMobile activeSection={activeSection} onNavigate={scrollToSection} />
