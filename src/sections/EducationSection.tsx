    ...
    >
      ...
      <div className="flex flex-wrap items-baseline justify-between gap-4 pb-8 border-b border-[#E2DDD2]">
        <div className="flex items-baseline gap-3">
          <span className="text-sm font-mono text-[#D94E28] font-bold">§05</span>
          ...
          {EDUCATION_DATA.map((edu) => (
            ...
            >
              ...
              <div className="mt-auto space-y-5 relative z-10 pl-2">
                {/* Score Badge */}
                <div className="inline-flex items-center px-3 py-1.5 rounded bg-[#653E31]/80 group-hover:bg-[#D94E28]/20 border border-[#855140] group-hover:border-[#D94E28]/40 text-xs font-mono text-white/90 group-hover:text-white transition-colors shadow-sm">
                  {edu.scoreOrStatus}
                </div>
